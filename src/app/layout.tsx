...
export default function RootLayout({children}:{children:React.ReactNode}){
 ...
 return <html lang="ru"><body>
  <header className="topbar"><div className="topbar-inner">
   <BoomCoreLogo small />
   <nav className="nav">
    <Link href="/cases">Кейсы</Link><Link href="/upgrade">Апгрейд</Link><Link href="/battles">Баттлы</Link><Link href="/bonus">Бонусы</Link><Link href="/rules">Правила</Link><Link href="/deposit-skins">Скинами</Link><Link href="/admin">Админка</Link><Link href="/steam-check">Steam</Link><Link href="/support">Поддержка</Link>
   </nav>
